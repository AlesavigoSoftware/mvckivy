...
register("MKVTabsPrimary", module="mvckivy.uix.tab")
register("MKVTabsSecondary", module="mvckivy.uix.tab")
register("MKVTabsItem", module="mvckivy.uix.tab")
register("MKVTabsItemSecondary", module="mvckivy.uix.tab")
register("MKVTabsItemIcon", module="mvckivy.uix.tab")
register("MKVTabsItemText", module="mvckivy.uix.tab")
register("MKVTabsCarousel", module="mvckivy.uix.tab")
register("MKVTabsBadge", module="mvckivy.uix.tab")
