...
from mvckivy.uix.behaviors import ButtonHoverBehavior
...
class AutoResizeMDIconButton(
    ...
    """Icon button with KV layout and Python logic via AliasProperties."""
    ...
    # geometry: provide radius list for KV binding
    ...
    # --- Derived RGBA for background (canvas) ---
